...
class SyntaxAnalyzer:
    ...
    def main(token_set: list[Token]):
        ...
        if(SyntaxAnalyzer.validate()):
            write_to_main_table(SyntaxAnalyzer.semanticAnalyzer.main_type_table)
            return "Syntax Valid"
    ...
    @staticmethod
    def start() -> bool:
        # { fixed, abstract, class, $function, $mfunction, enum, interface }
        if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part in ['fixed', 'abstract', 'class', '$function', '$mfunction', 'enum', 'interface']):
                    ...
                    if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "main"):
                        ...
                        if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "void"):
                            ...
                            if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "("):
                                ...
                                if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == ")"):
                                    SyntaxAnalyzer.current_index += 1
                                    SemanticAnalyzer.insert_mt(SyntaxAnalyzer.semanticAnalyzer, 'main', '_->void', "-", "-", "-")
                                    if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "{"):
                                        SyntaxAnalyzer.current_index += 1
                                        SyntaxAnalyzer.semanticAnalyzer.create_scope()
                                        if(SyntaxAnalyzer.mst()):
                                            if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "}"):
                                                SyntaxAnalyzer.current_index += 1
                                                SyntaxAnalyzer.semanticAnalyzer.destroy_scope()
                                                if(SyntaxAnalyzer.defs()):
                                                    return True
        return False
        ...
        # { enum }
            ...
            if(SyntaxAnalyzer.enum()):
                if(SyntaxAnalyzer.defs()):
                    return True
        # { interface }
        elif(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part in ['interface']):
            if(SyntaxAnalyzer.interface_dec()):
                if(SyntaxAnalyzer.defs()):
                    return True
    ...
    @staticmethod
    def class_dec():
        implements = {"status": True, "impl": "-"}
        extends = {"status": True, "ext": "-"}
        id = ''
        # { fixed, abstract, class }
        if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part in ["fixed", "abstract", "class"]):
            if(SyntaxAnalyzer.fixed()):
                if(SyntaxAnalyzer.abstract()):
                    if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "class"):
                        SyntaxAnalyzer.current_index += 1
                        if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "ID"):
                            id = SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].value_part
                            SyntaxAnalyzer.current_index += 1
                            if(SyntaxAnalyzer.interface(implements).get("status")):
                                SemanticAnalyzer.insert_mt(SyntaxAnalyzer.semanticAnalyzer, id, 'class', "shared", extends.get("ext", "-") , implements.get("impl", '-'))
                                if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "{"):
                                    SyntaxAnalyzer.current_index += 1
                                    SyntaxAnalyzer.semanticAnalyzer.create_scope()
    ...
    @staticmethod
    def inheritance(extends):
        # { child_of }
        if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "child_of"):
            SyntaxAnalyzer.current_index += 1
            if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "ID"):
                extends["ext"] = SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].value_part
                SyntaxAnalyzer.current_index += 1
                if(SyntaxAnalyzer.multi_id(extends).get("status")):
                    return extends
        # { { }
        elif(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "{"):
            return extends
        extends["status"] = False
        return extends

    @staticmethod
    def multi_id(extends):
        # { , }
        if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == ","):
            extends["ext"] += SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].value_part
            SyntaxAnalyzer.current_index += 1
    ...
    @staticmethod
    def interface_dec() -> bool:
        # { interface }
        if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "interface"):
            SyntaxAnalyzer.current_index += 1
            if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "ID"):
                SemanticAnalyzer.insert_mt(SyntaxAnalyzer.semanticAnalyzer, SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].value_part, 'interface', "-", "-", "-")
                SyntaxAnalyzer.current_index += 1
                if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "{"):
                        SyntaxAnalyzer.current_index += 1
                        SyntaxAnalyzer.semanticAnalyzer.create_scope()
                        if(SyntaxAnalyzer.interface_body()):
                            if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "}"):
                                SyntaxAnalyzer.current_index += 1
                                SyntaxAnalyzer.semanticAnalyzer.destroy_scope()
                                return True
        # { fixed, abstract, class, $function, enum, interface, $mfunction, $ }
        elif(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part in ["fixed", "abstract", "class", "$function", "enum", "interface", "$mfunction","$"]):
            return True
        return False
    ...
    def interface_body() -> bool:
                    ...
                    if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "("):
                        ...
                        if(SyntaxAnalyzer.paramerter()):
                            if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == ")"):
                                ...
                                if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == ";"):
                                    SyntaxAnalyzer.current_index += 1
                                    if(SyntaxAnalyzer.interface_body1()):
                                        return True
        # { } }
        elif(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "}"):
        ...
        return False
    @staticmethod
    def interface_body1() -> bool:
        # { take, $function }
        if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part in ["take", "$function"]):
            if(SyntaxAnalyzer.interface_body()):
                return True
        elif(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "}"):
            return True
    ...
    @staticmethod
    def interface(implements):
        # { implements }
        if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "implements"):
            SyntaxAnalyzer.current_index += 1
            if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "ID"):
                implements["impl"] = SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].value_part
                SyntaxAnalyzer.current_index += 1
                if(SyntaxAnalyzer.interface1(implements)):
                    return implements
        # { child_of, { }
        elif(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part in ["child_of", "{"]):
            return implements
        
        implements["status"] = False
        return implements
        
    @staticmethod
    def interface1(implements):
        # { , }
        if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == ","):
            implements["impl"] += SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].value_part
            SyntaxAnalyzer.current_index += 1
            if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "ID"):
                ...
                if(SyntaxAnalyzer.interface1(implements).get("status")):
                    return implements
        # { child_of, { }
        elif(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part in ["child_of", "{"]):
            return implements
    ...
    def enum() -> bool:
        ...
        if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "enum"):
            SyntaxAnalyzer.current_index += 1
            if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "ID"):
                SemanticAnalyzer.insert_mt(SyntaxAnalyzer.semanticAnalyzer,SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].value_part, "enum", "shared", "-", "-")
                SyntaxAnalyzer.current_index += 1
                if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "assignment"):
                    SyntaxAnalyzer.current_index += 1
                    if(SyntaxAnalyzer.token_set[SyntaxAnalyzer.current_index].class_part == "{"):
